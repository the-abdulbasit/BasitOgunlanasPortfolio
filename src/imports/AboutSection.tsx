...
function About() {
  ...
  return (
    <div className="content-stretch flex flex-col font-['Inter',sans-serif] font-normal gap-[20px] items-start not-italic relative shrink-0 text-[#f5f5f5] text-[16px] w-full" data-name="About">
      <p className="leading-[1.45] relative shrink-0 w-full">Designers often say the best designs are subtle — I believe they are not just subtle, rather they engage the user's curiosity and leave an impression.</p>
